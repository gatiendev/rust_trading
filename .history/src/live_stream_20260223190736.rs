...
pub async fn run(
    ...
    let feature_slice = &raw_window[raw_window.len().saturating_sub(FEATURE_WINDOW_SIZE)..];
    ...
    utils::log_memory_breakdown(&raw_window, &feature_window, &features_df);
